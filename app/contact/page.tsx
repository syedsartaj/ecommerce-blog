          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Have a question or need assistance? We're here to help you with all your shopping needs
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-3 gap-8 mb-16">
              <div className="text-center p-6">
                ...
                <a href="mailto:support@example.com" className="text-10b981 hover:underline">
                  support@example.com
                </a>
              </div>
              ...
              <div className="text-center p-6">
                ...
                <a href="tel:+18005551234" className="text-10b981 hover:underline">
                  1-800-555-1234
                </a>
              </div>
              ...
              <div className="text-center p-6">
                ...
                <button className="text-10b981 hover:underline">
                  Start Chat
                </button>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full px-6 py-3 bg-10b981 text-white font-medium rounded-lg hover:bg-green-600 transition-colors"
                  >
                    Send Message
                  </button>
                </form>
              ...
              <div>
                ...
                <div className="mt-6">
                  ...
                  <div className="flex gap-4">
                    <a href="#" className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center hover:bg-10b981 hover:text-white transition-colors">
